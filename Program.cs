...
class Program
{
    ...
    {
        var Person1 = new Person("Ivan", "Popov", DateTime.Now);
        var Person2 = new Person("Alexey", "Vasilyev", DateTime.Now);

        var date1 = DateTime.Now;
        var date2 = new DateTime(2006, 03, 05);
        var date3 = new DateTime(2003, 6, 30);
        ...
        student.Exam = new Exam[] { new Exam("DotaTwo", 4, date3) };
        student.Group = 10;

        student.AddExams(new Exam("Examss", 3, date1), new Exam("ABCDEFG", 5, date2));

        student2.AddExams(new Exam("LublyuOAIP<3", 5, date1), new Exam("PE", 5, date2));
